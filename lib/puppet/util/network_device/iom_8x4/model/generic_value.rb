ass has the base methods for parsing and keeping resource type(Like vlan, portchannel etc) valuesrequire 'puppet/util/network_device/iom_8x4/model'

class Puppet::Util::NetworkDevice::Iom_8x4::Model::GenericValue
