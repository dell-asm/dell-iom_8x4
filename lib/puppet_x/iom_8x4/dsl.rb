...
require 'puppet_x/iom_8x4/possible_facts/base'
require 'puppet_x/iom_8x4/fact'
require 'puppet_x/sorter'
require 'puppet_x/iom_8x4/possible_facts/custom'
  ...
  module Iom8x4
    module Dsl
      ...
      def evaluate_new_params
        PuppetX::Sorter.new(@params).tsort.each do |param|
      ...
      def register_model(param, klass, match_re, fetch_cmd)
        register_param param, PuppetX::Iom8x4::Model::ModelValue do
          model klass
          match match_re
          cmd fetch_cmd
        end
